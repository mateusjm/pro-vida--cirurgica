...
const ServicesDetails = () => {
  ...
  if (!servico) {
    return <div>LServiço não encontrado.</div>;
  }
        ...
        <Container className={`mb-5`}>
          ...
          <Row>
            <Col xxl={6} xl={6} md={6} sm={12} className='text-center'>
              <img width={500} className='img-fluid' src={servico.image} alt={servico.name} />
            </Col>
            <Col xxl={6} xl={5} md={6} sm={12} className={`p-4 ${styles.text_justify_custom}`}>
