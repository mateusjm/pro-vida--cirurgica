  ...
  <>
    <Navbar 
      ...
      <Container>
        <Navbar.Brand>
          <LinkContainer to='/'>
            <Nav.Link onClick={handleNavItemClick}><img width={150} src={logo} alt="Logo Pró-Vida Cirúrgica"/></Nav.Link>
          </LinkContainer>
        </Navbar.Brand>
          ...
          <Nav className="ms-auto p-2">
            <LinkContainer to="/">
              <Nav.Link 
                ...
                onClick={handleNavItemClick}>Home</Nav.Link>
            </LinkContainer>
            <LinkContainer to="/locacoes">
              <Nav.Link 
                active={location.pathname === "/locacoes"} 
                onClick={handleNavItemClick}>Locações</Nav.Link>
            </LinkContainer>
            <LinkContainer to="/servicos">
              <Nav.Link 
                active={location.pathname === "/servicos"} 
                onClick={handleNavItemClick}>Serviços</Nav.Link>
            </LinkContainer>
          </Nav>
